...
#define __PYX_HAVE__implicit_cy
#define __PYX_HAVE_API__implicit_cy
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'implicit_cy' */
static float __pyx_f_11implicit_cy_a(float, float); /*proto*/
static float __pyx_f_11implicit_cy_f1(float, float, float, float, float, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "implicit_cy"
int __pyx_module_is_main_implicit_cy = 0;

/* Implementation of 'implicit_cy' */
...
static const char __pyx_k_lambertw[] = "lambertw";
...
static PyObject *__pyx_n_s_lambertw;
...
static PyObject *__pyx_pf_11implicit_cy_f1(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_u_temp, float __pyx_v_multiplier, float __pyx_v_x_norm, float __pyx_v_learning_rate, float __pyx_v_u_old); /* proto */
...
static float __pyx_f_11implicit_cy_a(float __pyx_v_u_temp, float __pyx_v_multiplier) {
  float __pyx_v_diff;
  float __pyx_v_return_val;
  float __pyx_r;
 ...
 *     if diff < -15:
 */
  __pyx_v_diff = (__pyx_v_multiplier - __pyx_v_u_temp);
 ...
 *         return_val = 0.0             # <<<<<<<<<<<<<<
 *     elif diff > 15:
 *         return_val = log(diff) - log(log(diff))
 */
    __pyx_v_return_val = 0.0;
 ...
 */
    __pyx_v_return_val = (log(__pyx_v_diff) - log(log(__pyx_v_diff)));
 ...
 */
  /*else*/ {
    ...
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_real); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_lambertw); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 16, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyFloat_FromDouble(exp(__pyx_v_diff)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 16, __pyx_L1_error)
    ...
    if (!__pyx_t_7) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
    ...
    if (!__pyx_t_5) {
      ...
      #endif
      {
        ...
        __pyx_t_3 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      }
    }
 ...
 */
  ...
  __Pyx_WriteUnraisable("implicit_cy.a", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_11implicit_cy_1f1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static float __pyx_f_11implicit_cy_f1(float __pyx_v_u_temp, float __pyx_v_multiplier, float __pyx_v_x_norm, float __pyx_v_learning_rate, float __pyx_v_u_old, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_a_temp;
  float __pyx_v_return_value;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
  float __pyx_t_1;
  float __pyx_t_2;
 ...
 */
  __pyx_v_a_temp = __pyx_f_11implicit_cy_a(__pyx_v_u_temp, __pyx_v_multiplier);
 ...
 */
  __pyx_t_1 = (1.0 + __pyx_v_a_temp);
  if (unlikely(__pyx_t_1 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 25, __pyx_L1_error)
  }
  __pyx_t_2 = (__pyx_v_a_temp / __pyx_t_1);
 ...
 *     return return_value
 */
  __pyx_t_1 = powf(__pyx_v_a_temp, 2.0);
  __pyx_t_3 = (1.0 + __pyx_v_a_temp);
 ...
 *     return return_value
 */
  __pyx_v_return_value = (((((2.0 * __pyx_v_learning_rate) - ((2.0 * __pyx_v_learning_rate) * exp((-__pyx_v_u_temp)))) - (__pyx_t_2 / __pyx_v_x_norm)) + (2.0 * (__pyx_v_u_temp - __pyx_v_u_old))) - (__pyx_t_4 / __pyx_v_x_norm));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("implicit_cy.f1", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_11implicit_cy_1f1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11implicit_cy_f1[] = "First derivative of u equation";
static PyObject *__pyx_pw_11implicit_cy_1f1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  float __pyx_v_u_temp;
  float __pyx_v_multiplier;
  float __pyx_v_x_norm;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_u_temp,&__pyx_n_s_multiplier,&__pyx_n_s_x_norm,&__pyx_n_s_learning_rate,&__pyx_n_s_u_old,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_u_temp)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_multiplier)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 1); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x_norm)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 2); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_learning_rate)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 3); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_u_old)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 4); __PYX_ERR(0, 20, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_u_temp = __pyx_PyFloat_AsFloat(values[0]); if (unlikely((__pyx_v_u_temp == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_multiplier = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_multiplier == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_x_norm = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_x_norm == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_learning_rate = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_learning_rate == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_u_old = __pyx_PyFloat_AsFloat(values[4]); if (unlikely((__pyx_v_u_old == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 20, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("implicit_cy.f1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11implicit_cy_f1(__pyx_self, __pyx_v_u_temp, __pyx_v_multiplier, __pyx_v_x_norm, __pyx_v_learning_rate, __pyx_v_u_old);
...
static PyObject *__pyx_pf_11implicit_cy_f1(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_u_temp, float __pyx_v_multiplier, float __pyx_v_x_norm, float __pyx_v_learning_rate, float __pyx_v_u_old) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("f1", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_11implicit_cy_f1(__pyx_v_u_temp, __pyx_v_multiplier, __pyx_v_x_norm, __pyx_v_learning_rate, __pyx_v_u_old, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"f1", (PyCFunction)__pyx_pw_11implicit_cy_1f1, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11implicit_cy_f1},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_lambertw, __pyx_k_lambertw, sizeof(__pyx_k_lambertw), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initimplicit_cy(void); /*proto*/
PyMODINIT_FUNC initimplicit_cy(void)
#else
PyMODINIT_FUNC PyInit_implicit_cy(void); /*proto*/
PyMODINIT_FUNC PyInit_implicit_cy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_implicit_cy(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("implicit_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_implicit_cy) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "implicit_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "implicit_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_s_lambertw);
  __Pyx_GIVEREF(__pyx_n_s_lambertw);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_lambertw);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_scipy_special, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_lambertw); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_lambertw, __pyx_t_1) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init implicit_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init implicit_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
