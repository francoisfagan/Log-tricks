 ...
 *     else:
 */
    __pyx_v_a_temp = (((((__pyx_v_L1 - __pyx_v_L2) + (__pyx_v_L2 / __pyx_v_L1)) + ((__pyx_v_L2 * (-2.0 + __pyx_v_L2)) / (2.0 * powf(__pyx_v_L1, 2.0)))) + ((__pyx_v_L2 * ((6.0 - (9.0 * __pyx_v_L2)) + (2.0 * powf(__pyx_v_L2, 2.0)))) / (6.0 * powf(__pyx_v_L1, 3.0)))) + ((__pyx_v_L2 * (((-12.0 + (36.0 * __pyx_v_L2)) - (22.0 * powf(__pyx_v_L2, 2.0))) + (3.0 * powf(__pyx_v_L2, 3.0)))) / (12.0 * powf(__pyx_v_L1, 4.0))));
 ...
 */
  /*else*/ {
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_lambertw); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
    ...
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_diff); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_7 = NULL;
    ...
    if (!__pyx_t_7) {
      ...
      #endif
      {
        ...
        __pyx_t_5 = 0;
        __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_8, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 26, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
    ...
    __pyx_t_9 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_9 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     return return_value
 */
  __pyx_v_return_value = (((((2.0 * __pyx_v_learning_rate) - ((2.0 * __pyx_v_learning_rate) * exp((-__pyx_v_u_temp)))) - ((__pyx_v_a_temp / (1.0 + __pyx_v_a_temp)) / __pyx_v_x_norm)) + (2.0 * (__pyx_v_u_temp - __pyx_v_u_old))) - ((powf(__pyx_v_a_temp, 2.0) / (1.0 + __pyx_v_a_temp)) / __pyx_v_x_norm));
...
static PyObject *__pyx_pw_11implicit_cy_1f1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("f1 (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_multiplier)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x_norm)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_learning_rate)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_u_old)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, 4); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "f1") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_u_temp = __pyx_PyFloat_AsFloat(values[0]); if (unlikely((__pyx_v_u_temp == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_multiplier = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_multiplier == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_x_norm = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_x_norm == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_learning_rate = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_learning_rate == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_u_old = __pyx_PyFloat_AsFloat(values[4]); if (unlikely((__pyx_v_u_old == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("f1", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_11implicit_cy_f1(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_u_temp, float __pyx_v_multiplier, float __pyx_v_x_norm, float __pyx_v_learning_rate, float __pyx_v_u_old) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_11implicit_cy_f1(__pyx_v_u_temp, __pyx_v_multiplier, __pyx_v_x_norm, __pyx_v_learning_rate, __pyx_v_u_old, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
