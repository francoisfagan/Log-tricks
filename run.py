...
def run(train, test, num_train_points, x, y, y_one_hot, W, b, idx, u, cost,
        learning_rate, batch_size, num_epochs_record_cost, num_repeat, training_epochs, error, num_classes):
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(training_epochs):
                ...
                for i_batch in range(num_batches):
                    ...
                    _, c = sess.run([optimizer, cost], feed_dict={x: batch_xs, y_one_hot: batch_ys, idx: batch_idx})
